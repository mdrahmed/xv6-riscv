...
int create_or_close_the_buffer_user(char name[16], int open_close){
 ...
 27e:	b2e48493          	addi	s1,s1,-1234 # da8 <rings+0x10>
 282:	00001917          	auipc	s2,0x1
 286:	c1690913          	addi	s2,s2,-1002 # e98 <__BSS_END__>
 28a:	04f59563          	bne	a1,a5,2d4 <create_or_close_the_buffer_user+0x70>
    for(i = 0; i < 10; i++){
      if(rings[i].exists == 0){
 28e:	00001497          	auipc	s1,0x1
 292:	b1a4a483          	lw	s1,-1254(s1) # da8 <rings+0x10>
 ...
 2a0:	afc90913          	addi	s2,s2,-1284 # d98 <rings>
 2a4:	00093603          	ld	a2,0(s2)
 2a8:	4585                	li	a1,1
 2aa:	00000097          	auipc	ra,0x0
 2ae:	4de080e7          	jalr	1246(ra) # 788 <ringbuf>
 ...
 2e4:	4a8080e7          	jalr	1192(ra) # 788 <ringbuf>
        rings[i].exists = 0;
...
void ringbuf_start_write(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 31a:	a8270713          	addi	a4,a4,-1406 # d98 <rings>
 31e:	97ba                	add	a5,a5,a4
 320:	6798                	ld	a4,8(a5)
 322:	671c                	ld	a5,8(a4)
 324:	00178693          	addi	a3,a5,1
 328:	e714                	sd	a3,8(a4)
 32a:	17d2                	slli	a5,a5,0x34
 32c:	93d1                	srli	a5,a5,0x34
 32e:	6741                	lui	a4,0x10
 330:	40f707b3          	sub	a5,a4,a5
 334:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 336:	421c                	lw	a5,0(a2)
 338:	e79d                	bnez	a5,366 <ringbuf_start_write+0x64>
    *bytes = 4096*16 -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 33a:	00001697          	auipc	a3,0x1
 33e:	a5e68693          	addi	a3,a3,-1442 # d98 <rings>
 342:	669c                	ld	a5,8(a3)
 344:	6398                	ld	a4,0(a5)
 ...
 372:	a2a78793          	addi	a5,a5,-1494 # d98 <rings>
 ...
 386:	bfd9                	j	35c <ringbuf_start_write+0x5a>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 39c:	a0050513          	addi	a0,a0,-1536 # d98 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 3d2:	9ca50513          	addi	a0,a0,-1590 # d98 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 408:	99450513          	addi	a0,a0,-1644 # d98 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 45e:	93e50513          	addi	a0,a0,-1730 # d98 <rings>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 656:	fed70fa3          	sb	a3,-1(a4) # ffff <__global_pointer$+0xea76>
    while(n-- > 0)
...
free(void *ap)
{
 ...
 aac:	2e87b783          	ld	a5,744(a5) # d90 <freep>
 ...
 ada:	00e6ea63          	bltu	a3,a4,aee <free+0x50>
{
 ...
 b1c:	26f73c23          	sd	a5,632(a4) # d90 <freep>
}
 b20:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 b4e:	24653503          	ld	a0,582(a0) # d90 <freep>
 ...
 b76:	21e90913          	addi	s2,s2,542 # d90 <freep>
  if(p == (char*)-1)
 b7a:	5afd                	li	s5,-1
 b7c:	a895                	j	bf0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 b7e:	00000797          	auipc	a5,0x0
 b82:	30a78793          	addi	a5,a5,778 # e88 <base>
 b86:	00000717          	auipc	a4,0x0
 b8a:	20f73523          	sd	a5,522(a4) # d90 <freep>
 b8e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 bb2:	1ea73123          	sd	a0,482(a4) # d90 <freep>
      return (void*)(p + 1);
