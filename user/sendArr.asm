...
int create_or_close_the_buffer_user(char name[16], int open_close, uint64 **addr){
 168:	7139                	addi	sp,sp,-64
 16a:	fc06                	sd	ra,56(sp)
 16c:	f822                	sd	s0,48(sp)
 16e:	f426                	sd	s1,40(sp)
 170:	f04a                	sd	s2,32(sp)
 172:	ec4e                	sd	s3,24(sp)
 174:	e852                	sd	s4,16(sp)
 176:	e456                	sd	s5,8(sp)
 178:	e05a                	sd	s6,0(sp)
 ...
 188:	9e448493          	addi	s1,s1,-1564 # b68 <rings+0x8>
 18c:	00001917          	auipc	s2,0x1
 190:	acc90913          	addi	s2,s2,-1332 # c58 <base+0x8>
    }
  }
  else{
    for(i = 0; i < 10; i++){
 ...
 194:	00001b17          	auipc	s6,0x1
 198:	9bcb0b13          	addi	s6,s6,-1604 # b50 <vm_addr>
  if(open_close == 1){
 19c:	04f59063          	bne	a1,a5,1dc <create_or_close_the_buffer_user+0x74>
      if(rings[i].exists == 0){
 1a0:	00001497          	auipc	s1,0x1
 1a4:	9d04a483          	lw	s1,-1584(s1) # b70 <rings+0x10>
 1a8:	c099                	beqz	s1,1ae <create_or_close_the_buffer_user+0x46>
 1aa:	4481                	li	s1,0
 1ac:	a899                	j	202 <create_or_close_the_buffer_user+0x9a>
        ringbuf(name, open_close, &vm_addr);
 1ae:	865a                	mv	a2,s6
 1b0:	4585                	li	a1,1
 1b2:	00000097          	auipc	ra,0x0
 1b6:	4da080e7          	jalr	1242(ra) # 68c <ringbuf>
        rings[i].book->write_done = 0;
 1ba:	00001797          	auipc	a5,0x1
 1be:	9a678793          	addi	a5,a5,-1626 # b60 <rings>
 1c2:	6798                	ld	a4,8(a5)
 1c4:	00073423          	sd	zero,8(a4)
        rings[i].book->read_done = 0;
 1c8:	6798                	ld	a4,8(a5)
 1ca:	00073023          	sd	zero,0(a4)
        rings[i].exists++;
 1ce:	4b98                	lw	a4,16(a5)
 1d0:	2705                	addiw	a4,a4,1
 1d2:	cb98                	sw	a4,16(a5)
        break;
 1d4:	a03d                	j	202 <create_or_close_the_buffer_user+0x9a>
    for(i = 0; i < 10; i++){
 1d6:	04e1                	addi	s1,s1,24
 1d8:	03248463          	beq	s1,s2,200 <create_or_close_the_buffer_user+0x98>
      if(rings[i].exists != 0){
 1dc:	449c                	lw	a5,8(s1)
 1de:	dfe5                	beqz	a5,1d6 <create_or_close_the_buffer_user+0x6e>
        ringbuf(name, open_close, &vm_addr);
 1e0:	865a                	mv	a2,s6
 1e2:	85ce                	mv	a1,s3
 1e4:	8552                	mv	a0,s4
 1e6:	00000097          	auipc	ra,0x0
 1ea:	4a6080e7          	jalr	1190(ra) # 68c <ringbuf>
        rings[i].book->write_done = 0;
 1ee:	609c                	ld	a5,0(s1)
 1f0:	0007b423          	sd	zero,8(a5)
        rings[i].book->read_done = 0;
 1f4:	609c                	ld	a5,0(s1)
 1f6:	0007b023          	sd	zero,0(a5)
        rings[i].exists = 0;
 1fa:	0004a423          	sw	zero,8(s1)
 1fe:	bfe1                	j	1d6 <create_or_close_the_buffer_user+0x6e>
    for(i = 0; i < 10; i++){
 200:	44a9                	li	s1,10
 ...
 206:	94e7b783          	ld	a5,-1714(a5) # b50 <vm_addr>
 20a:	00fab023          	sd	a5,0(s5)
  return i;
}
 20e:	8526                	mv	a0,s1
...
0000000000000224 <ringbuf_start_write>:
...
void ringbuf_start_write(int ring_desc, uint64 **addr, int *bytes){ 
 ...
 234:	9207b783          	ld	a5,-1760(a5) # b50 <vm_addr>
 238:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 23a:	421c                	lw	a5,0(a2)
 23c:	e79d                	bnez	a5,26a <ringbuf_start_write+0x46>
    *bytes = (4096*16) -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 23e:	00001697          	auipc	a3,0x1
 242:	92268693          	addi	a3,a3,-1758 # b60 <rings>
 246:	669c                	ld	a5,8(a3)
 248:	6398                	ld	a4,0(a5)
 ...
 276:	8ee78793          	addi	a5,a5,-1810 # b60 <rings>
 ...
 28a:	bfd9                	j	260 <ringbuf_start_write+0x3c>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 2a0:	8c450513          	addi	a0,a0,-1852 # b60 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 2d6:	88e50513          	addi	a0,a0,-1906 # b60 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ 
 ...
 30c:	85850513          	addi	a0,a0,-1960 # b60 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 362:	80250513          	addi	a0,a0,-2046 # b60 <rings>
...
free(void *ap)
{
 ...
 9b0:	1ac7b783          	ld	a5,428(a5) # b58 <freep>
 ...
 9de:	00e6ea63          	bltu	a3,a4,9f2 <free+0x50>
{
 ...
 a20:	12f73e23          	sd	a5,316(a4) # b58 <freep>
}
 a24:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 a52:	10a53503          	ld	a0,266(a0) # b58 <freep>
 ...
 a7a:	0e290913          	addi	s2,s2,226 # b58 <freep>
  if(p == (char*)-1)
 a7e:	5afd                	li	s5,-1
 a80:	a895                	j	af4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 a82:	00000797          	auipc	a5,0x0
 a86:	1ce78793          	addi	a5,a5,462 # c50 <base>
 a8a:	00000717          	auipc	a4,0x0
 a8e:	0cf73723          	sd	a5,206(a4) # b58 <freep>
 a92:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 ab6:	0aa73323          	sd	a0,166(a4) # b58 <freep>
      return (void*)(p + 1);
