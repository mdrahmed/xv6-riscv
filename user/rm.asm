...
main(int argc, char *argv[])
{
  ...
  2e:	54e080e7          	jalr	1358(ra) # 578 <unlink>
...
int create_or_close_the_buffer_user(char name[16], int open_close, uint64 **addr){
  ...
  if(open_close == 1){
  be:	4785                	li	a5,1
  c0:	00001497          	auipc	s1,0x1
  c4:	a0048493          	addi	s1,s1,-1536 # ac0 <rings+0x8>
  c8:	00001917          	auipc	s2,0x1
  cc:	ae890913          	addi	s2,s2,-1304 # bb0 <base+0x8>
    }
  }
  else{
    for(i = 0; i < 10; i++){
  ...
  d0:	00001b17          	auipc	s6,0x1
  d4:	9d8b0b13          	addi	s6,s6,-1576 # aa8 <vm_addr>
  if(open_close == 1){
  d8:	04f59063          	bne	a1,a5,118 <create_or_close_the_buffer_user+0x74>
      if(rings[i].exists == 0){
  dc:	00001497          	auipc	s1,0x1
  e0:	9ec4a483          	lw	s1,-1556(s1) # ac8 <rings+0x10>
  e4:	c099                	beqz	s1,ea <create_or_close_the_buffer_user+0x46>
  e6:	4481                	li	s1,0
  e8:	a899                	j	13e <create_or_close_the_buffer_user+0x9a>
        ringbuf(name, open_close, &vm_addr);
  ea:	865a                	mv	a2,s6
  ec:	4585                	li	a1,1
  ee:	00000097          	auipc	ra,0x0
  f2:	4da080e7          	jalr	1242(ra) # 5c8 <ringbuf>
        rings[i].book->write_done = 0;
  f6:	00001797          	auipc	a5,0x1
  fa:	9c278793          	addi	a5,a5,-1598 # ab8 <rings>
  fe:	6798                	ld	a4,8(a5)
 100:	00073423          	sd	zero,8(a4)
        rings[i].book->read_done = 0;
 104:	6798                	ld	a4,8(a5)
 106:	00073023          	sd	zero,0(a4)
        rings[i].exists++;
 10a:	4b98                	lw	a4,16(a5)
 10c:	2705                	addiw	a4,a4,1
 10e:	cb98                	sw	a4,16(a5)
        break;
 110:	a03d                	j	13e <create_or_close_the_buffer_user+0x9a>
    for(i = 0; i < 10; i++){
 112:	04e1                	addi	s1,s1,24
 114:	03248463          	beq	s1,s2,13c <create_or_close_the_buffer_user+0x98>
      if(rings[i].exists != 0){
 118:	449c                	lw	a5,8(s1)
 11a:	dfe5                	beqz	a5,112 <create_or_close_the_buffer_user+0x6e>
        ringbuf(name, open_close, &vm_addr);
 11c:	865a                	mv	a2,s6
 11e:	85ce                	mv	a1,s3
 120:	8552                	mv	a0,s4
 122:	00000097          	auipc	ra,0x0
 126:	4a6080e7          	jalr	1190(ra) # 5c8 <ringbuf>
        rings[i].book->write_done = 0;
 12a:	609c                	ld	a5,0(s1)
 12c:	0007b423          	sd	zero,8(a5)
        rings[i].book->read_done = 0;
 130:	609c                	ld	a5,0(s1)
 132:	0007b023          	sd	zero,0(a5)
        rings[i].exists = 0;
 136:	0004a423          	sw	zero,8(s1)
 13a:	bfe1                	j	112 <create_or_close_the_buffer_user+0x6e>
    for(i = 0; i < 10; i++){
 13c:	44a9                	li	s1,10
 ...
 142:	96a7b783          	ld	a5,-1686(a5) # aa8 <vm_addr>
 146:	00fab023          	sd	a5,0(s5)
  return i;
}
 14a:	8526                	mv	a0,s1
 14c:	70e2                	ld	ra,56(sp)
 14e:	7442                	ld	s0,48(sp)
 150:	74a2                	ld	s1,40(sp)
 152:	7902                	ld	s2,32(sp)
 154:	69e2                	ld	s3,24(sp)
 156:	6a42                	ld	s4,16(sp)
 158:	6aa2                	ld	s5,8(sp)
 15a:	6b02                	ld	s6,0(sp)
 15c:	6121                	addi	sp,sp,64
 15e:	8082                	ret

0000000000000160 <ringbuf_start_write>:
...
void ringbuf_start_write(int ring_desc, uint64 **addr, int *bytes){ 
 ...
 170:	93c7b783          	ld	a5,-1732(a5) # aa8 <vm_addr>
 174:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 176:	421c                	lw	a5,0(a2)
 178:	e79d                	bnez	a5,1a6 <ringbuf_start_write+0x46>
    *bytes = (4096*16) -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 17a:	00001697          	auipc	a3,0x1
 17e:	93e68693          	addi	a3,a3,-1730 # ab8 <rings>
 182:	669c                	ld	a5,8(a3)
 184:	6398                	ld	a4,0(a5)
 ...
 1b2:	90a78793          	addi	a5,a5,-1782 # ab8 <rings>
 ...
 1c6:	bfd9                	j	19c <ringbuf_start_write+0x3c>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 1dc:	8e050513          	addi	a0,a0,-1824 # ab8 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 212:	8aa50513          	addi	a0,a0,-1878 # ab8 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ 
 ...
 248:	87450513          	addi	a0,a0,-1932 # ab8 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 29e:	81e50513          	addi	a0,a0,-2018 # ab8 <rings>
...
free(void *ap)
{
 ...
 8ec:	1c87b783          	ld	a5,456(a5) # ab0 <freep>
 ...
 91a:	00e6ea63          	bltu	a3,a4,92e <free+0x50>
{
 ...
 95c:	14f73c23          	sd	a5,344(a4) # ab0 <freep>
}
 960:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 98e:	12653503          	ld	a0,294(a0) # ab0 <freep>
 ...
 9b6:	0fe90913          	addi	s2,s2,254 # ab0 <freep>
  if(p == (char*)-1)
 9ba:	5afd                	li	s5,-1
 9bc:	a895                	j	a30 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 9be:	00000797          	auipc	a5,0x0
 9c2:	1ea78793          	addi	a5,a5,490 # ba8 <base>
 9c6:	00000717          	auipc	a4,0x0
 9ca:	0ef73523          	sd	a5,234(a4) # ab0 <freep>
 9ce:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9f2:	0ca73123          	sd	a0,194(a4) # ab0 <freep>
      return (void*)(p + 1);
