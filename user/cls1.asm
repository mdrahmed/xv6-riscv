...
int create_or_close_the_buffer_user(char name[16], int open_close, uint64 **addr){
 248:	7139                	addi	sp,sp,-64
 24a:	fc06                	sd	ra,56(sp)
 24c:	f822                	sd	s0,48(sp)
 24e:	f426                	sd	s1,40(sp)
 250:	f04a                	sd	s2,32(sp)
 252:	ec4e                	sd	s3,24(sp)
 254:	e852                	sd	s4,16(sp)
 256:	e456                	sd	s5,8(sp)
 258:	e05a                	sd	s6,0(sp)
 25a:	0080                	addi	s0,sp,64
 25c:	8a2a                	mv	s4,a0
 25e:	89ae                	mv	s3,a1
 260:	8ab2                	mv	s5,a2
  int i=0;
 ...
 268:	adc48493          	addi	s1,s1,-1316 # d40 <rings+0x8>
 26c:	00001917          	auipc	s2,0x1
 270:	bc490913          	addi	s2,s2,-1084 # e30 <base+0x8>
    }
  }
  else{
    for(i = 0; i < 10; i++){
 ...
 278:	ab4b0b13          	addi	s6,s6,-1356 # d28 <vm_addr>
  if(open_close == 1){
 27c:	04f59063          	bne	a1,a5,2bc <create_or_close_the_buffer_user+0x74>
      if(rings[i].exists == 0){
 280:	00001497          	auipc	s1,0x1
 284:	ac84a483          	lw	s1,-1336(s1) # d48 <rings+0x10>
 288:	c099                	beqz	s1,28e <create_or_close_the_buffer_user+0x46>
 28a:	4481                	li	s1,0
 28c:	a899                	j	2e2 <create_or_close_the_buffer_user+0x9a>
        ringbuf(name, open_close, &vm_addr);
 28e:	865a                	mv	a2,s6
 290:	4585                	li	a1,1
 292:	00000097          	auipc	ra,0x0
 296:	4da080e7          	jalr	1242(ra) # 76c <ringbuf>
        rings[i].book->write_done = 0;
 29a:	00001797          	auipc	a5,0x1
 29e:	a9e78793          	addi	a5,a5,-1378 # d38 <rings>
 2a2:	6798                	ld	a4,8(a5)
 2a4:	00073423          	sd	zero,8(a4)
        rings[i].book->read_done = 0;
 2a8:	6798                	ld	a4,8(a5)
 2aa:	00073023          	sd	zero,0(a4)
        rings[i].exists++;
 2ae:	4b98                	lw	a4,16(a5)
 2b0:	2705                	addiw	a4,a4,1
 2b2:	cb98                	sw	a4,16(a5)
        break;
 2b4:	a03d                	j	2e2 <create_or_close_the_buffer_user+0x9a>
    for(i = 0; i < 10; i++){
 2b6:	04e1                	addi	s1,s1,24
 2b8:	03248463          	beq	s1,s2,2e0 <create_or_close_the_buffer_user+0x98>
      if(rings[i].exists != 0){
 2bc:	449c                	lw	a5,8(s1)
 2be:	dfe5                	beqz	a5,2b6 <create_or_close_the_buffer_user+0x6e>
        ringbuf(name, open_close, &vm_addr);
 2c0:	865a                	mv	a2,s6
 2c2:	85ce                	mv	a1,s3
 2c4:	8552                	mv	a0,s4
 2c6:	00000097          	auipc	ra,0x0
 2ca:	4a6080e7          	jalr	1190(ra) # 76c <ringbuf>
        rings[i].book->write_done = 0;
 2ce:	609c                	ld	a5,0(s1)
 2d0:	0007b423          	sd	zero,8(a5)
        rings[i].book->read_done = 0;
 2d4:	609c                	ld	a5,0(s1)
 2d6:	0007b023          	sd	zero,0(a5)
        rings[i].exists = 0;
 2da:	0004a423          	sw	zero,8(s1)
 2de:	bfe1                	j	2b6 <create_or_close_the_buffer_user+0x6e>
    for(i = 0; i < 10; i++){
 2e0:	44a9                	li	s1,10
 ...
 2e6:	a467b783          	ld	a5,-1466(a5) # d28 <vm_addr>
 2ea:	00fab023          	sd	a5,0(s5)
  return i;
}
 2ee:	8526                	mv	a0,s1
...
0000000000000304 <ringbuf_start_write>:
...
void ringbuf_start_write(int ring_desc, uint64 **addr, int *bytes){ 
 ...
 314:	a187b783          	ld	a5,-1512(a5) # d28 <vm_addr>
 318:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 31a:	421c                	lw	a5,0(a2)
 31c:	e79d                	bnez	a5,34a <ringbuf_start_write+0x46>
    *bytes = (4096*16) -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 31e:	00001697          	auipc	a3,0x1
 322:	a1a68693          	addi	a3,a3,-1510 # d38 <rings>
 326:	669c                	ld	a5,8(a3)
 328:	6398                	ld	a4,0(a5)
 ...
 356:	9e678793          	addi	a5,a5,-1562 # d38 <rings>
 ...
 36a:	bfd9                	j	340 <ringbuf_start_write+0x3c>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 380:	9bc50513          	addi	a0,a0,-1604 # d38 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 3b6:	98650513          	addi	a0,a0,-1658 # d38 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ 
 ...
 3ec:	95050513          	addi	a0,a0,-1712 # d38 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 442:	8fa50513          	addi	a0,a0,-1798 # d38 <rings>
...
free(void *ap)
{
 ...
 a90:	2a47b783          	ld	a5,676(a5) # d30 <freep>
 ...
 abe:	00e6ea63          	bltu	a3,a4,ad2 <free+0x50>
{
 ...
 b00:	22f73a23          	sd	a5,564(a4) # d30 <freep>
}
 b04:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 b32:	20253503          	ld	a0,514(a0) # d30 <freep>
 ...
 b5a:	1da90913          	addi	s2,s2,474 # d30 <freep>
  if(p == (char*)-1)
 b5e:	5afd                	li	s5,-1
 b60:	a895                	j	bd4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 b62:	00000797          	auipc	a5,0x0
 b66:	2c678793          	addi	a5,a5,710 # e28 <base>
 b6a:	00000717          	auipc	a4,0x0
 b6e:	1cf73323          	sd	a5,454(a4) # d30 <freep>
 b72:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 b96:	18a73f23          	sd	a0,414(a4) # d30 <freep>
      return (void*)(p + 1);
