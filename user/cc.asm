...
int create_or_close_the_buffer_user(char name[16], int open_close, uint64 **addr){
  ...
  e8:	9d448493          	addi	s1,s1,-1580 # ab8 <rings+0x8>
  ec:	00001917          	auipc	s2,0x1
  f0:	abc90913          	addi	s2,s2,-1348 # ba8 <base+0x8>
    }
  }
  else{
    for(i = 0; i < 10; i++){
  ...
  f8:	9acb0b13          	addi	s6,s6,-1620 # aa0 <vm_addr>
  if(open_close == 1){
  fc:	04f59063          	bne	a1,a5,13c <create_or_close_the_buffer_user+0x74>
      if(rings[i].exists == 0){
 100:	00001497          	auipc	s1,0x1
 104:	9c04a483          	lw	s1,-1600(s1) # ac0 <rings+0x10>
 108:	c099                	beqz	s1,10e <create_or_close_the_buffer_user+0x46>
 10a:	4481                	li	s1,0
 10c:	a899                	j	162 <create_or_close_the_buffer_user+0x9a>
        ringbuf(name, open_close, &vm_addr);
 10e:	865a                	mv	a2,s6
 110:	4585                	li	a1,1
 112:	00000097          	auipc	ra,0x0
 116:	4da080e7          	jalr	1242(ra) # 5ec <ringbuf>
        rings[i].book->write_done = 0;
 11a:	00001797          	auipc	a5,0x1
 11e:	99678793          	addi	a5,a5,-1642 # ab0 <rings>
 122:	6798                	ld	a4,8(a5)
 124:	00073423          	sd	zero,8(a4) # ffffffff80000008 <__global_pointer$+0xffffffff7fffed77>
        rings[i].book->read_done = 0;
 128:	6798                	ld	a4,8(a5)
 12a:	00073023          	sd	zero,0(a4)
        rings[i].exists++;
 12e:	4b98                	lw	a4,16(a5)
 130:	2705                	addiw	a4,a4,1
 132:	cb98                	sw	a4,16(a5)
        break;
 134:	a03d                	j	162 <create_or_close_the_buffer_user+0x9a>
    for(i = 0; i < 10; i++){
 136:	04e1                	addi	s1,s1,24
 138:	03248463          	beq	s1,s2,160 <create_or_close_the_buffer_user+0x98>
      if(rings[i].exists != 0){
 13c:	449c                	lw	a5,8(s1)
 13e:	dfe5                	beqz	a5,136 <create_or_close_the_buffer_user+0x6e>
        ringbuf(name, open_close, &vm_addr);
 140:	865a                	mv	a2,s6
 142:	85ce                	mv	a1,s3
 144:	8552                	mv	a0,s4
 146:	00000097          	auipc	ra,0x0
 14a:	4a6080e7          	jalr	1190(ra) # 5ec <ringbuf>
        rings[i].book->write_done = 0;
 14e:	609c                	ld	a5,0(s1)
 150:	0007b423          	sd	zero,8(a5)
        rings[i].book->read_done = 0;
 154:	609c                	ld	a5,0(s1)
 156:	0007b023          	sd	zero,0(a5)
        rings[i].exists = 0;
 15a:	0004a423          	sw	zero,8(s1)
 15e:	bfe1                	j	136 <create_or_close_the_buffer_user+0x6e>
    for(i = 0; i < 10; i++){
 160:	44a9                	li	s1,10
 ...
 166:	93e7b783          	ld	a5,-1730(a5) # aa0 <vm_addr>
 16a:	00fab023          	sd	a5,0(s5)
  return i;
}
 16e:	8526                	mv	a0,s1
...
0000000000000184 <ringbuf_start_write>:
...
void ringbuf_start_write(int ring_desc, uint64 **addr, int *bytes){ 
 ...
 194:	9107b783          	ld	a5,-1776(a5) # aa0 <vm_addr>
 198:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 19a:	421c                	lw	a5,0(a2)
 19c:	e79d                	bnez	a5,1ca <ringbuf_start_write+0x46>
    *bytes = (4096*16) -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 19e:	00001697          	auipc	a3,0x1
 1a2:	91268693          	addi	a3,a3,-1774 # ab0 <rings>
 1a6:	669c                	ld	a5,8(a3)
 1a8:	6398                	ld	a4,0(a5)
 ...
 1d6:	8de78793          	addi	a5,a5,-1826 # ab0 <rings>
 ...
 1ea:	bfd9                	j	1c0 <ringbuf_start_write+0x3c>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 200:	8b450513          	addi	a0,a0,-1868 # ab0 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 236:	87e50513          	addi	a0,a0,-1922 # ab0 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ 
 ...
 26c:	84850513          	addi	a0,a0,-1976 # ab0 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 2c2:	7f250513          	addi	a0,a0,2034 # ab0 <rings>
...
free(void *ap)
{
 ...
 910:	19c7b783          	ld	a5,412(a5) # aa8 <freep>
 ...
 93e:	00e6ea63          	bltu	a3,a4,952 <free+0x50>
{
 ...
 980:	12f73623          	sd	a5,300(a4) # aa8 <freep>
}
 984:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9b2:	0fa53503          	ld	a0,250(a0) # aa8 <freep>
 ...
 9da:	0d290913          	addi	s2,s2,210 # aa8 <freep>
  if(p == (char*)-1)
 9de:	5afd                	li	s5,-1
 ...
 9ee:	0af73f23          	sd	a5,190(a4) # aa8 <freep>
 9f2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a16:	08a73b23          	sd	a0,150(a4) # aa8 <freep>
      return (void*)(p + 1);
