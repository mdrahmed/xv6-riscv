...
int create_or_close_the_buffer_user(char name[16], int open_close){
 ...
 13e:	a5648493          	addi	s1,s1,-1450 # b90 <rings+0x10>
 142:	00001917          	auipc	s2,0x1
 146:	b3e90913          	addi	s2,s2,-1218 # c80 <__BSS_END__>
 14a:	04f59563          	bne	a1,a5,194 <create_or_close_the_buffer_user+0x70>
    for(i = 0; i < 10; i++){
      if(rings[i].exists == 0){
 14e:	00001497          	auipc	s1,0x1
 152:	a424a483          	lw	s1,-1470(s1) # b90 <rings+0x10>
 ...
 160:	a2490913          	addi	s2,s2,-1500 # b80 <rings>
 164:	00093603          	ld	a2,0(s2)
 168:	4585                	li	a1,1
 16a:	00000097          	auipc	ra,0x0
 16e:	4de080e7          	jalr	1246(ra) # 648 <ringbuf>
 ...
 1a4:	4a8080e7          	jalr	1192(ra) # 648 <ringbuf>
        rings[i].exists = 0;
...
void ringbuf_start_write(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 1da:	9aa70713          	addi	a4,a4,-1622 # b80 <rings>
 1de:	97ba                	add	a5,a5,a4
 1e0:	6798                	ld	a4,8(a5)
 1e2:	671c                	ld	a5,8(a4)
 1e4:	00178693          	addi	a3,a5,1
 1e8:	e714                	sd	a3,8(a4)
 1ea:	17d2                	slli	a5,a5,0x34
 1ec:	93d1                	srli	a5,a5,0x34
 1ee:	6741                	lui	a4,0x10
 1f0:	40f707b3          	sub	a5,a4,a5
 1f4:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 1f6:	421c                	lw	a5,0(a2)
 1f8:	e79d                	bnez	a5,226 <ringbuf_start_write+0x64>
    *bytes = 4096*16 -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 1fa:	00001697          	auipc	a3,0x1
 1fe:	98668693          	addi	a3,a3,-1658 # b80 <rings>
 202:	669c                	ld	a5,8(a3)
 204:	6398                	ld	a4,0(a5)
 ...
 232:	95278793          	addi	a5,a5,-1710 # b80 <rings>
 ...
 246:	bfd9                	j	21c <ringbuf_start_write+0x5a>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 25c:	92850513          	addi	a0,a0,-1752 # b80 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 292:	8f250513          	addi	a0,a0,-1806 # b80 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 2c8:	8bc50513          	addi	a0,a0,-1860 # b80 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 31e:	86650513          	addi	a0,a0,-1946 # b80 <rings>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 516:	fed70fa3          	sb	a3,-1(a4) # ffff <__global_pointer$+0xec97>
    while(n-- > 0)
...
free(void *ap)
{
 ...
 96c:	2107b783          	ld	a5,528(a5) # b78 <freep>
 ...
 99a:	00e6ea63          	bltu	a3,a4,9ae <free+0x50>
{
 ...
 9dc:	1af73023          	sd	a5,416(a4) # b78 <freep>
}
 9e0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 a0e:	16e53503          	ld	a0,366(a0) # b78 <freep>
 ...
 a36:	14690913          	addi	s2,s2,326 # b78 <freep>
  if(p == (char*)-1)
 a3a:	5afd                	li	s5,-1
 a3c:	a895                	j	ab0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 a3e:	00000797          	auipc	a5,0x0
 a42:	23278793          	addi	a5,a5,562 # c70 <base>
 a46:	00000717          	auipc	a4,0x0
 a4a:	12f73923          	sd	a5,306(a4) # b78 <freep>
 a4e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a72:	10a73523          	sd	a0,266(a4) # b78 <freep>
      return (void*)(p + 1);
