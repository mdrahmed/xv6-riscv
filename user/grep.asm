...
000000000000011a <grep>:
{
 ...
 13e:	b9ea8a93          	addi	s5,s5,-1122 # cd8 <buf>
...
int create_or_close_the_buffer_user(char name[16], int open_close){
 ...
 2e4:	e0848493          	addi	s1,s1,-504 # 10e8 <rings+0x10>
 2e8:	00001917          	auipc	s2,0x1
 2ec:	ef090913          	addi	s2,s2,-272 # 11d8 <__BSS_END__>
 2f0:	04f59563          	bne	a1,a5,33a <create_or_close_the_buffer_user+0x70>
    for(i = 0; i < 10; i++){
      if(rings[i].exists == 0){
 2f4:	00001497          	auipc	s1,0x1
 2f8:	df44a483          	lw	s1,-524(s1) # 10e8 <rings+0x10>
 ...
 306:	dd690913          	addi	s2,s2,-554 # 10d8 <rings>
 30a:	00093603          	ld	a2,0(s2)
 30e:	4585                	li	a1,1
 310:	00000097          	auipc	ra,0x0
 314:	4de080e7          	jalr	1246(ra) # 7ee <ringbuf>
 ...
 34a:	4a8080e7          	jalr	1192(ra) # 7ee <ringbuf>
        rings[i].exists = 0;
...
void ringbuf_start_write(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 380:	d5c70713          	addi	a4,a4,-676 # 10d8 <rings>
 384:	97ba                	add	a5,a5,a4
 386:	6798                	ld	a4,8(a5)
 388:	671c                	ld	a5,8(a4)
 38a:	00178693          	addi	a3,a5,1
 38e:	e714                	sd	a3,8(a4)
 390:	17d2                	slli	a5,a5,0x34
 392:	93d1                	srli	a5,a5,0x34
 394:	6741                	lui	a4,0x10
 396:	40f707b3          	sub	a5,a4,a5
 39a:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 39c:	421c                	lw	a5,0(a2)
 39e:	e79d                	bnez	a5,3cc <ringbuf_start_write+0x64>
    *bytes = 4096*16 -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 3a0:	00001697          	auipc	a3,0x1
 3a4:	d3868693          	addi	a3,a3,-712 # 10d8 <rings>
 3a8:	669c                	ld	a5,8(a3)
 3aa:	6398                	ld	a4,0(a5)
 ...
 3d8:	d0478793          	addi	a5,a5,-764 # 10d8 <rings>
 ...
 3ec:	bfd9                	j	3c2 <ringbuf_start_write+0x5a>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 402:	cda50513          	addi	a0,a0,-806 # 10d8 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 438:	ca450513          	addi	a0,a0,-860 # 10d8 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 46e:	c6e50513          	addi	a0,a0,-914 # 10d8 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 4c4:	c1850513          	addi	a0,a0,-1000 # 10d8 <rings>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 6bc:	fed70fa3          	sb	a3,-1(a4) # ffff <__global_pointer$+0xeb36>
    while(n-- > 0)
...
free(void *ap)
{
 ...
 b12:	1c27b783          	ld	a5,450(a5) # cd0 <freep>
 ...
 b40:	00e6ea63          	bltu	a3,a4,b54 <free+0x50>
{
 ...
 b82:	14f73923          	sd	a5,338(a4) # cd0 <freep>
}
 b86:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 bb4:	12053503          	ld	a0,288(a0) # cd0 <freep>
 ...
 bdc:	0f890913          	addi	s2,s2,248 # cd0 <freep>
  if(p == (char*)-1)
 be0:	5afd                	li	s5,-1
 be2:	a895                	j	c56 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 be4:	00000797          	auipc	a5,0x0
 be8:	5e478793          	addi	a5,a5,1508 # 11c8 <base>
 bec:	00000717          	auipc	a4,0x0
 bf0:	0ef73223          	sd	a5,228(a4) # cd0 <freep>
 bf4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 c18:	0aa73e23          	sd	a0,188(a4) # cd0 <freep>
      return (void*)(p + 1);
