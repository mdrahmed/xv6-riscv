...
int create_or_close_the_buffer_user(char name[16], int open_close, uint64 **addr){
 ...
 198:	9e448493          	addi	s1,s1,-1564 # b78 <rings+0x8>
 19c:	00001917          	auipc	s2,0x1
 1a0:	acc90913          	addi	s2,s2,-1332 # c68 <base+0x8>
    }
  }
  else{
    for(i = 0; i < 10; i++){
 ...
 1a8:	9bcb0b13          	addi	s6,s6,-1604 # b60 <vm_addr>
  if(open_close == 1){
 1ac:	04f59063          	bne	a1,a5,1ec <create_or_close_the_buffer_user+0x74>
      if(rings[i].exists == 0){
 1b0:	00001497          	auipc	s1,0x1
 1b4:	9d04a483          	lw	s1,-1584(s1) # b80 <rings+0x10>
 1b8:	c099                	beqz	s1,1be <create_or_close_the_buffer_user+0x46>
 1ba:	4481                	li	s1,0
 1bc:	a899                	j	212 <create_or_close_the_buffer_user+0x9a>
        ringbuf(name, open_close, &vm_addr);
 1be:	865a                	mv	a2,s6
 1c0:	4585                	li	a1,1
 1c2:	00000097          	auipc	ra,0x0
 1c6:	4da080e7          	jalr	1242(ra) # 69c <ringbuf>
        rings[i].book->write_done = 0;
 1ca:	00001797          	auipc	a5,0x1
 1ce:	9a678793          	addi	a5,a5,-1626 # b70 <rings>
 1d2:	6798                	ld	a4,8(a5)
 1d4:	00073423          	sd	zero,8(a4)
        rings[i].book->read_done = 0;
 1d8:	6798                	ld	a4,8(a5)
 1da:	00073023          	sd	zero,0(a4)
        rings[i].exists++;
 1de:	4b98                	lw	a4,16(a5)
 1e0:	2705                	addiw	a4,a4,1
 1e2:	cb98                	sw	a4,16(a5)
        break;
 1e4:	a03d                	j	212 <create_or_close_the_buffer_user+0x9a>
    for(i = 0; i < 10; i++){
 1e6:	04e1                	addi	s1,s1,24
 1e8:	03248463          	beq	s1,s2,210 <create_or_close_the_buffer_user+0x98>
      if(rings[i].exists != 0){
 1ec:	449c                	lw	a5,8(s1)
 1ee:	dfe5                	beqz	a5,1e6 <create_or_close_the_buffer_user+0x6e>
        ringbuf(name, open_close, &vm_addr);
 1f0:	865a                	mv	a2,s6
 1f2:	85ce                	mv	a1,s3
 1f4:	8552                	mv	a0,s4
 1f6:	00000097          	auipc	ra,0x0
 1fa:	4a6080e7          	jalr	1190(ra) # 69c <ringbuf>
        rings[i].book->write_done = 0;
 1fe:	609c                	ld	a5,0(s1)
 200:	0007b423          	sd	zero,8(a5)
        rings[i].book->read_done = 0;
 204:	609c                	ld	a5,0(s1)
 206:	0007b023          	sd	zero,0(a5)
        rings[i].exists = 0;
 20a:	0004a423          	sw	zero,8(s1)
 20e:	bfe1                	j	1e6 <create_or_close_the_buffer_user+0x6e>
    for(i = 0; i < 10; i++){
 210:	44a9                	li	s1,10
 ...
 21a:	00fab023          	sd	a5,0(s5)
  return i;
}
 21e:	8526                	mv	a0,s1
 220:	70e2                	ld	ra,56(sp)
 222:	7442                	ld	s0,48(sp)
 224:	74a2                	ld	s1,40(sp)
 226:	7902                	ld	s2,32(sp)
 228:	69e2                	ld	s3,24(sp)
 22a:	6a42                	ld	s4,16(sp)
 22c:	6aa2                	ld	s5,8(sp)
 22e:	6b02                	ld	s6,0(sp)
 230:	6121                	addi	sp,sp,64
 232:	8082                	ret

0000000000000234 <ringbuf_start_write>:
...
void ringbuf_start_write(int ring_desc, uint64 **addr, int *bytes){ 
 ...
 244:	9207b783          	ld	a5,-1760(a5) # b60 <vm_addr>
 248:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 24a:	421c                	lw	a5,0(a2)
 24c:	e79d                	bnez	a5,27a <ringbuf_start_write+0x46>
    *bytes = (4096*16) -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 24e:	00001697          	auipc	a3,0x1
 252:	92268693          	addi	a3,a3,-1758 # b70 <rings>
 256:	669c                	ld	a5,8(a3)
 258:	6398                	ld	a4,0(a5)
 ...
 286:	8ee78793          	addi	a5,a5,-1810 # b70 <rings>
 ...
 29a:	bfd9                	j	270 <ringbuf_start_write+0x3c>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 2b0:	8c450513          	addi	a0,a0,-1852 # b70 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 2e6:	88e50513          	addi	a0,a0,-1906 # b70 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ 
 ...
 31c:	85850513          	addi	a0,a0,-1960 # b70 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 372:	80250513          	addi	a0,a0,-2046 # b70 <rings>
...
free(void *ap)
{
 ...
 9c0:	1ac7b783          	ld	a5,428(a5) # b68 <freep>
 ...
 9ee:	00e6ea63          	bltu	a3,a4,a02 <free+0x50>
{
 ...
 a30:	12f73e23          	sd	a5,316(a4) # b68 <freep>
}
 a34:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 a62:	10a53503          	ld	a0,266(a0) # b68 <freep>
 ...
 a8a:	0e290913          	addi	s2,s2,226 # b68 <freep>
  if(p == (char*)-1)
 a8e:	5afd                	li	s5,-1
 a90:	a895                	j	b04 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 a92:	00000797          	auipc	a5,0x0
 a96:	1ce78793          	addi	a5,a5,462 # c60 <base>
 a9a:	00000717          	auipc	a4,0x0
 a9e:	0cf73723          	sd	a5,206(a4) # b68 <freep>
 aa2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 ac6:	0aa73323          	sd	a0,166(a4) # b68 <freep>
      return (void*)(p + 1);
