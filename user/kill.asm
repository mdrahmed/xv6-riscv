...
int create_or_close_the_buffer_user(char name[16], int open_close, uint64 **addr){
  ...
  b0:	9dc48493          	addi	s1,s1,-1572 # a88 <rings+0x8>
  b4:	00001917          	auipc	s2,0x1
  b8:	ac490913          	addi	s2,s2,-1340 # b78 <base+0x8>
    }
  }
  else{
    for(i = 0; i < 10; i++){
  ...
  bc:	00001b17          	auipc	s6,0x1
  c0:	9b4b0b13          	addi	s6,s6,-1612 # a70 <vm_addr>
  if(open_close == 1){
  c4:	04f59063          	bne	a1,a5,104 <create_or_close_the_buffer_user+0x74>
      if(rings[i].exists == 0){
  c8:	00001497          	auipc	s1,0x1
  cc:	9c84a483          	lw	s1,-1592(s1) # a90 <rings+0x10>
  d0:	c099                	beqz	s1,d6 <create_or_close_the_buffer_user+0x46>
  d2:	4481                	li	s1,0
  d4:	a899                	j	12a <create_or_close_the_buffer_user+0x9a>
        ringbuf(name, open_close, &vm_addr);
  d6:	865a                	mv	a2,s6
  d8:	4585                	li	a1,1
  da:	00000097          	auipc	ra,0x0
  de:	4da080e7          	jalr	1242(ra) # 5b4 <ringbuf>
        rings[i].book->write_done = 0;
  e2:	00001797          	auipc	a5,0x1
  e6:	99e78793          	addi	a5,a5,-1634 # a80 <rings>
  ea:	6798                	ld	a4,8(a5)
  ec:	00073423          	sd	zero,8(a4)
        rings[i].book->read_done = 0;
  f0:	6798                	ld	a4,8(a5)
  f2:	00073023          	sd	zero,0(a4)
        rings[i].exists++;
  f6:	4b98                	lw	a4,16(a5)
  f8:	2705                	addiw	a4,a4,1
  fa:	cb98                	sw	a4,16(a5)
        break;
  fc:	a03d                	j	12a <create_or_close_the_buffer_user+0x9a>
    for(i = 0; i < 10; i++){
  fe:	04e1                	addi	s1,s1,24
 100:	03248463          	beq	s1,s2,128 <create_or_close_the_buffer_user+0x98>
      if(rings[i].exists != 0){
 104:	449c                	lw	a5,8(s1)
 106:	dfe5                	beqz	a5,fe <create_or_close_the_buffer_user+0x6e>
        ringbuf(name, open_close, &vm_addr);
 108:	865a                	mv	a2,s6
 10a:	85ce                	mv	a1,s3
 10c:	8552                	mv	a0,s4
 10e:	00000097          	auipc	ra,0x0
 112:	4a6080e7          	jalr	1190(ra) # 5b4 <ringbuf>
        rings[i].book->write_done = 0;
 116:	609c                	ld	a5,0(s1)
 118:	0007b423          	sd	zero,8(a5)
        rings[i].book->read_done = 0;
 11c:	609c                	ld	a5,0(s1)
 11e:	0007b023          	sd	zero,0(a5)
        rings[i].exists = 0;
 122:	0004a423          	sw	zero,8(s1)
 126:	bfe1                	j	fe <create_or_close_the_buffer_user+0x6e>
    for(i = 0; i < 10; i++){
 128:	44a9                	li	s1,10
 ...
 12e:	9467b783          	ld	a5,-1722(a5) # a70 <vm_addr>
 132:	00fab023          	sd	a5,0(s5)
  return i;
}
 136:	8526                	mv	a0,s1
...
000000000000014c <ringbuf_start_write>:
...
void ringbuf_start_write(int ring_desc, uint64 **addr, int *bytes){ 
 ...
 15c:	9187b783          	ld	a5,-1768(a5) # a70 <vm_addr>
 160:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 162:	421c                	lw	a5,0(a2)
 164:	e79d                	bnez	a5,192 <ringbuf_start_write+0x46>
    *bytes = (4096*16) -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 166:	00001697          	auipc	a3,0x1
 16a:	91a68693          	addi	a3,a3,-1766 # a80 <rings>
 16e:	669c                	ld	a5,8(a3)
 170:	6398                	ld	a4,0(a5)
 ...
 19e:	8e678793          	addi	a5,a5,-1818 # a80 <rings>
 ...
 1b2:	bfd9                	j	188 <ringbuf_start_write+0x3c>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 1c8:	8bc50513          	addi	a0,a0,-1860 # a80 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 1fe:	88650513          	addi	a0,a0,-1914 # a80 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ 
 ...
 234:	85050513          	addi	a0,a0,-1968 # a80 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 28a:	7fa50513          	addi	a0,a0,2042 # a80 <rings>
...
free(void *ap)
{
 ...
 8d8:	1a47b783          	ld	a5,420(a5) # a78 <freep>
 ...
 906:	00e6ea63          	bltu	a3,a4,91a <free+0x50>
{
 ...
 948:	12f73a23          	sd	a5,308(a4) # a78 <freep>
}
 94c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 97a:	10253503          	ld	a0,258(a0) # a78 <freep>
 ...
 9a2:	0da90913          	addi	s2,s2,218 # a78 <freep>
  if(p == (char*)-1)
 9a6:	5afd                	li	s5,-1
 9a8:	a895                	j	a1c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 9aa:	00000797          	auipc	a5,0x0
 9ae:	1c678793          	addi	a5,a5,454 # b70 <base>
 9b2:	00000717          	auipc	a4,0x0
 9b6:	0cf73323          	sd	a5,198(a4) # a78 <freep>
 9ba:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9de:	08a73f23          	sd	a0,158(a4) # a78 <freep>
      return (void*)(p + 1);
