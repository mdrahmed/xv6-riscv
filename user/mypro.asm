...
int create_or_close_the_buffer_user(char name[16], int open_close){
  ...
  fe:	9fe48493          	addi	s1,s1,-1538 # af8 <rings+0x10>
 102:	00001917          	auipc	s2,0x1
 106:	ae690913          	addi	s2,s2,-1306 # be8 <__BSS_END__>
 10a:	04f59563          	bne	a1,a5,154 <create_or_close_the_buffer_user+0x70>
    for(i = 0; i < 10; i++){
      if(rings[i].exists == 0){
 10e:	00001497          	auipc	s1,0x1
 112:	9ea4a483          	lw	s1,-1558(s1) # af8 <rings+0x10>
 ...
 120:	9cc90913          	addi	s2,s2,-1588 # ae8 <rings>
 124:	00093603          	ld	a2,0(s2)
 128:	4585                	li	a1,1
 12a:	00000097          	auipc	ra,0x0
 12e:	4de080e7          	jalr	1246(ra) # 608 <ringbuf>
 ...
 164:	4a8080e7          	jalr	1192(ra) # 608 <ringbuf>
        rings[i].exists = 0;
...
void ringbuf_start_write(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 19a:	95270713          	addi	a4,a4,-1710 # ae8 <rings>
 19e:	97ba                	add	a5,a5,a4
 1a0:	6798                	ld	a4,8(a5)
 1a2:	671c                	ld	a5,8(a4)
 1a4:	00178693          	addi	a3,a5,1
 1a8:	e714                	sd	a3,8(a4)
 1aa:	17d2                	slli	a5,a5,0x34
 1ac:	93d1                	srli	a5,a5,0x34
 1ae:	6741                	lui	a4,0x10
 1b0:	40f707b3          	sub	a5,a4,a5
 1b4:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 1b6:	421c                	lw	a5,0(a2)
 1b8:	e79d                	bnez	a5,1e6 <ringbuf_start_write+0x64>
    *bytes = 4096*16 -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 1ba:	00001697          	auipc	a3,0x1
 1be:	92e68693          	addi	a3,a3,-1746 # ae8 <rings>
 1c2:	669c                	ld	a5,8(a3)
 1c4:	6398                	ld	a4,0(a5)
 ...
 1f2:	8fa78793          	addi	a5,a5,-1798 # ae8 <rings>
 ...
 206:	bfd9                	j	1dc <ringbuf_start_write+0x5a>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 21c:	8d050513          	addi	a0,a0,-1840 # ae8 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 252:	89a50513          	addi	a0,a0,-1894 # ae8 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 288:	86450513          	addi	a0,a0,-1948 # ae8 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 2de:	80e50513          	addi	a0,a0,-2034 # ae8 <rings>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 4d6:	fed70fa3          	sb	a3,-1(a4) # ffff <__global_pointer$+0xed26>
    while(n-- > 0)
...
free(void *ap)
{
 ...
 92c:	1b87b783          	ld	a5,440(a5) # ae0 <freep>
 ...
 95a:	00e6ea63          	bltu	a3,a4,96e <free+0x50>
{
 ...
 99c:	14f73423          	sd	a5,328(a4) # ae0 <freep>
}
 9a0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9ce:	11653503          	ld	a0,278(a0) # ae0 <freep>
 ...
 9f6:	0ee90913          	addi	s2,s2,238 # ae0 <freep>
  if(p == (char*)-1)
 9fa:	5afd                	li	s5,-1
 9fc:	a895                	j	a70 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 9fe:	00000797          	auipc	a5,0x0
 a02:	1da78793          	addi	a5,a5,474 # bd8 <base>
 a06:	00000717          	auipc	a4,0x0
 a0a:	0cf73d23          	sd	a5,218(a4) # ae0 <freep>
 a0e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a32:	0aa73923          	sd	a0,178(a4) # ae0 <freep>
      return (void*)(p + 1);
