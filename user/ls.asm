...
fmtname(char *path)
{
  ...
  6a:	ce298993          	addi	s3,s3,-798 # d48 <buf.0>
...
int create_or_close_the_buffer_user(char name[16], int open_close, uint64 **addr){
 ...
 30c:	e852                	sd	s4,16(sp)
 30e:	e456                	sd	s5,8(sp)
 310:	e05a                	sd	s6,0(sp)
 312:	0080                	addi	s0,sp,64
 314:	8a2a                	mv	s4,a0
 316:	89ae                	mv	s3,a1
 318:	8ab2                	mv	s5,a2
  int i=0;
  ...
  if(open_close == 1){
 31a:	4785                	li	a5,1
 31c:	00001497          	auipc	s1,0x1
 320:	a4448493          	addi	s1,s1,-1468 # d60 <rings+0x8>
 324:	00001917          	auipc	s2,0x1
 328:	b2c90913          	addi	s2,s2,-1236 # e50 <base+0x8>
    }
  }
  else{
    for(i = 0; i < 10; i++){
 ...
 32c:	00001b17          	auipc	s6,0x1
 330:	a0cb0b13          	addi	s6,s6,-1524 # d38 <vm_addr>
  if(open_close == 1){
 334:	04f59063          	bne	a1,a5,374 <create_or_close_the_buffer_user+0x74>
      if(rings[i].exists == 0){
 338:	00001497          	auipc	s1,0x1
 33c:	a304a483          	lw	s1,-1488(s1) # d68 <rings+0x10>
 340:	c099                	beqz	s1,346 <create_or_close_the_buffer_user+0x46>
 342:	4481                	li	s1,0
 344:	a899                	j	39a <create_or_close_the_buffer_user+0x9a>
        ringbuf(name, open_close, &vm_addr);
 346:	865a                	mv	a2,s6
 348:	4585                	li	a1,1
 34a:	00000097          	auipc	ra,0x0
 34e:	4da080e7          	jalr	1242(ra) # 824 <ringbuf>
        rings[i].book->write_done = 0;
 352:	00001797          	auipc	a5,0x1
 356:	a0678793          	addi	a5,a5,-1530 # d58 <rings>
 35a:	6798                	ld	a4,8(a5)
 35c:	00073423          	sd	zero,8(a4)
        rings[i].book->read_done = 0;
 360:	6798                	ld	a4,8(a5)
 362:	00073023          	sd	zero,0(a4)
        rings[i].exists++;
 366:	4b98                	lw	a4,16(a5)
 368:	2705                	addiw	a4,a4,1
 36a:	cb98                	sw	a4,16(a5)
        break;
 36c:	a03d                	j	39a <create_or_close_the_buffer_user+0x9a>
    for(i = 0; i < 10; i++){
 36e:	04e1                	addi	s1,s1,24
 370:	03248463          	beq	s1,s2,398 <create_or_close_the_buffer_user+0x98>
      if(rings[i].exists != 0){
 374:	449c                	lw	a5,8(s1)
 376:	dfe5                	beqz	a5,36e <create_or_close_the_buffer_user+0x6e>
        ringbuf(name, open_close, &vm_addr);
 378:	865a                	mv	a2,s6
 37a:	85ce                	mv	a1,s3
 37c:	8552                	mv	a0,s4
 37e:	00000097          	auipc	ra,0x0
 382:	4a6080e7          	jalr	1190(ra) # 824 <ringbuf>
        rings[i].book->write_done = 0;
 386:	609c                	ld	a5,0(s1)
 388:	0007b423          	sd	zero,8(a5)
        rings[i].book->read_done = 0;
 38c:	609c                	ld	a5,0(s1)
 38e:	0007b023          	sd	zero,0(a5)
        rings[i].exists = 0;
 392:	0004a423          	sw	zero,8(s1)
 396:	bfe1                	j	36e <create_or_close_the_buffer_user+0x6e>
    for(i = 0; i < 10; i++){
 398:	44a9                	li	s1,10
 ...
 39e:	99e7b783          	ld	a5,-1634(a5) # d38 <vm_addr>
 3a2:	00fab023          	sd	a5,0(s5)
  return i;
}
 3a6:	8526                	mv	a0,s1
 ...
 3b2:	6a42                	ld	s4,16(sp)
 3b4:	6aa2                	ld	s5,8(sp)
 3b6:	6b02                	ld	s6,0(sp)
 3b8:	6121                	addi	sp,sp,64
 3ba:	8082                	ret

00000000000003bc <ringbuf_start_write>:
...
void ringbuf_start_write(int ring_desc, uint64 **addr, int *bytes){ 
 ...
 3cc:	9707b783          	ld	a5,-1680(a5) # d38 <vm_addr>
 3d0:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 3d2:	421c                	lw	a5,0(a2)
 3d4:	e79d                	bnez	a5,402 <ringbuf_start_write+0x46>
    *bytes = (4096*16) -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 3d6:	00001697          	auipc	a3,0x1
 3da:	98268693          	addi	a3,a3,-1662 # d58 <rings>
 3de:	669c                	ld	a5,8(a3)
 3e0:	6398                	ld	a4,0(a5)
 ...
 40e:	94e78793          	addi	a5,a5,-1714 # d58 <rings>
 ...
 422:	bfd9                	j	3f8 <ringbuf_start_write+0x3c>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 438:	92450513          	addi	a0,a0,-1756 # d58 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 46e:	8ee50513          	addi	a0,a0,-1810 # d58 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ 
 ...
 4a4:	8b850513          	addi	a0,a0,-1864 # d58 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 4fa:	86250513          	addi	a0,a0,-1950 # d58 <rings>
...
free(void *ap)
{
 ...
 b48:	1fc7b783          	ld	a5,508(a5) # d40 <freep>
 ...
 b76:	00e6ea63          	bltu	a3,a4,b8a <free+0x50>
{
 ...
 bb8:	18f73623          	sd	a5,396(a4) # d40 <freep>
}
 bbc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 bea:	15a53503          	ld	a0,346(a0) # d40 <freep>
 ...
 c12:	13290913          	addi	s2,s2,306 # d40 <freep>
  if(p == (char*)-1)
 c16:	5afd                	li	s5,-1
 c18:	a895                	j	c8c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 c1a:	00000797          	auipc	a5,0x0
 c1e:	22e78793          	addi	a5,a5,558 # e48 <base>
 c22:	00000717          	auipc	a4,0x0
 c26:	10f73f23          	sd	a5,286(a4) # d40 <freep>
 c2a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 c4e:	0ea73b23          	sd	a0,246(a4) # d40 <freep>
      return (void*)(p + 1);
