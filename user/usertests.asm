...
00000000000011b2 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    124a:	45a78793          	addi	a5,a5,1114 # 86a0 <big.0>
    124e:	00008697          	auipc	a3,0x8
    1252:	45268693          	addi	a3,a3,1106 # 96a0 <__global_pointer$+0x918>
      big[i] = 'x';
    ...
    1268:	42078e23          	sb	zero,1084(a5) # 96a0 <__global_pointer$+0x918>
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f4a:	e72b0b13          	addi	s6,s6,-398 # bdb8 <buf>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e5c8>
    pid = fork();
...
0000000000002188 <bigargtest>:
{
  ...
  close(fd);
    ...
    21f0:	3b478793          	addi	a5,a5,948 # 85a0 <args.1>
    21f4:	00006697          	auipc	a3,0x6
    21f8:	4a468693          	addi	a3,a3,1188 # 8698 <args.1+0xf8>
    ...
    2210:	39458593          	addi	a1,a1,916 # 85a0 <args.1>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22cc:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0148>
    22d0:	85a6                	mv	a1,s1
...
00000000000025b8 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    25f4:	6705                	lui	a4,0x1
      *b = 99;
    25f6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1148>
    for(b = a; b < a+TOOMUCH; b += 4096){
...
000000000000273c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    279e:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1147>
  a = sbrk(0);
    27a2:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2802:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1147>
...
0000000000003056 <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    313a:	c8258593          	addi	a1,a1,-894 # bdb8 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3150:	c6c74703          	lbu	a4,-916(a4) # bdb8 <buf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    321a:	ba258593          	addi	a1,a1,-1118 # bdb8 <buf>
...
0000000000003f74 <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4076:	d4658593          	addi	a1,a1,-698 # bdb8 <buf>
...
00000000000041c8 <sbrkfail>:
{
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4348:	6705                	lui	a4,0x1
      n += *(a+i);
    434a:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1148>
...
00000000000045da <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    467c:	740a0a13          	addi	s4,s4,1856 # bdb8 <buf>
    4680:	00007a97          	auipc	s5,0x7
    4684:	739a8a93          	addi	s5,s5,1849 # bdb9 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    478a:	63278793          	addi	a5,a5,1586 # bdb8 <buf>
...
0000000000004b76 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4bb6:	20690913          	addi	s2,s2,518 # bdb8 <buf>
  for(i = 0; i < N; i++){
    4bba:	4a51                	li	s4,20
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4c14:	1a890913          	addi	s2,s2,424 # bdb8 <buf>
  if(fd < 0){
...
0000000000004d56 <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4da2:	01aa0a13          	addi	s4,s4,26 # bdb8 <buf>
    name[0] = 'f';
...
0000000000004ef6 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4f0a:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187755>
    4f0e:	02f50533          	mul	a0,a0,a5
    4f12:	3c6ef7b7          	lui	a5,0x3c6ef
    4f16:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e04a7>
...
int create_or_close_the_buffer_user(char name[16], int open_close){
  ...
  if(open_close == 1){
    ...
    5478:	95448493          	addi	s1,s1,-1708 # edc8 <rings+0x10>
    547c:	0000a917          	auipc	s2,0xa
    5480:	a3c90913          	addi	s2,s2,-1476 # eeb8 <__BSS_END__>
    5484:	04f59563          	bne	a1,a5,54ce <create_or_close_the_buffer_user+0x70>
    for(i = 0; i < 10; i++){
      if(rings[i].exists == 0){
    5488:	0000a497          	auipc	s1,0xa
    548c:	9404a483          	lw	s1,-1728(s1) # edc8 <rings+0x10>
    ...
    549a:	92290913          	addi	s2,s2,-1758 # edb8 <rings>
    549e:	00093603          	ld	a2,0(s2)
    54a2:	4585                	li	a1,1
    54a4:	00000097          	auipc	ra,0x0
    54a8:	4de080e7          	jalr	1246(ra) # 5982 <ringbuf>
    ...
    54de:	4a8080e7          	jalr	1192(ra) # 5982 <ringbuf>
        rings[i].exists = 0;
...
void ringbuf_start_write(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
  ...
  *addr = (4096*16)-(rings[ring_desc].book->write_done++) % 4096;
    ...
    5514:	8a870713          	addi	a4,a4,-1880 # edb8 <rings>
    5518:	97ba                	add	a5,a5,a4
    551a:	6798                	ld	a4,8(a5)
    551c:	671c                	ld	a5,8(a4)
    551e:	00178693          	addi	a3,a5,1
    5522:	e714                	sd	a3,8(a4)
    5524:	17d2                	slli	a5,a5,0x34
    5526:	93d1                	srli	a5,a5,0x34
    5528:	6741                	lui	a4,0x10
    552a:	40f707b3          	sub	a5,a4,a5
    552e:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
    5530:	421c                	lw	a5,0(a2)
    5532:	e79d                	bnez	a5,5560 <ringbuf_start_write+0x64>
    *bytes = 4096*16 -(rings[ring_desc].book->write_done - rings[0].book->read_done);
    5534:	0000a697          	auipc	a3,0xa
    5538:	88468693          	addi	a3,a3,-1916 # edb8 <rings>
    ...
    *bytes = load(&(rings[ring_desc].book->write_done));
    ...
    556c:	85078793          	addi	a5,a5,-1968 # edb8 <rings>
    ...
    5580:	bfd9                	j	5556 <ringbuf_start_write+0x5a>
...
void ringbuf_finish_write(int ring_desc, int bytes){
  ...
  store(&(rings[ring_desc].book->write_done), bytes);
    ...
    5596:	82650513          	addi	a0,a0,-2010 # edb8 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
  ...
  *bytes = load(&(rings[ring_desc].book->write_done));
    ...
    55cc:	7f050513          	addi	a0,a0,2032 # edb8 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
  ...
  if(rings[ring_desc].book -> read_done == 0){
    ...
    5602:	7ba50513          	addi	a0,a0,1978 # edb8 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
  ...
  store(&(rings[ring_desc].book->read_done), bytes);
    ...
    5658:	76450513          	addi	a0,a0,1892 # edb8 <rings>
...
memmove(void *vdst, const void *vsrc, int n)
{
  ...
  dst = vdst;
    ...
    5850:	fed70fa3          	sb	a3,-1(a4) # ffff <__BSS_END__+0x1147>
    while(n-- > 0)
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5ca6:	8f67b783          	ld	a5,-1802(a5) # 8598 <freep>
    ...
    5cd4:	00e6ea63          	bltu	a3,a4,5ce8 <free+0x50>
{
  ...
  freep = p;
    ...
    5d16:	88f73323          	sd	a5,-1914(a4) # 8598 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5d48:	85453503          	ld	a0,-1964(a0) # 8598 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d70:	82c90913          	addi	s2,s2,-2004 # 8598 <freep>
  if(p == (char*)-1)
    5d74:	5afd                	li	s5,-1
    5d76:	a895                	j	5dea <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5d78:	00009797          	auipc	a5,0x9
    5d7c:	13078793          	addi	a5,a5,304 # eea8 <base>
    5d80:	00003717          	auipc	a4,0x3
    5d84:	80f73c23          	sd	a5,-2024(a4) # 8598 <freep>
    ...
    5dac:	7ea73823          	sd	a0,2032(a4) # 8598 <freep>
      return (void*)(p + 1);
