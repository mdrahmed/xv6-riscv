...
int create_or_close_the_buffer_user(char name[16], int open_close){
 ...
 210:	9e448493          	addi	s1,s1,-1564 # bf0 <rings+0x10>
 214:	00001917          	auipc	s2,0x1
 218:	acc90913          	addi	s2,s2,-1332 # ce0 <__BSS_END__>
 21c:	04f59563          	bne	a1,a5,266 <create_or_close_the_buffer_user+0x70>
    for(i = 0; i < 10; i++){
      if(rings[i].exists == 0){
 220:	00001497          	auipc	s1,0x1
 224:	9d04a483          	lw	s1,-1584(s1) # bf0 <rings+0x10>
 ...
 232:	9b290913          	addi	s2,s2,-1614 # be0 <rings>
 236:	00093603          	ld	a2,0(s2)
 23a:	4585                	li	a1,1
 23c:	00000097          	auipc	ra,0x0
 240:	4de080e7          	jalr	1246(ra) # 71a <ringbuf>
 ...
 276:	4a8080e7          	jalr	1192(ra) # 71a <ringbuf>
        rings[i].exists = 0;
...
void ringbuf_start_write(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 2ac:	93870713          	addi	a4,a4,-1736 # be0 <rings>
 2b0:	97ba                	add	a5,a5,a4
 2b2:	6798                	ld	a4,8(a5)
 2b4:	671c                	ld	a5,8(a4)
 2b6:	00178693          	addi	a3,a5,1
 2ba:	e714                	sd	a3,8(a4)
 2bc:	17d2                	slli	a5,a5,0x34
 2be:	93d1                	srli	a5,a5,0x34
 2c0:	6741                	lui	a4,0x10
 2c2:	40f707b3          	sub	a5,a4,a5
 2c6:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 2c8:	421c                	lw	a5,0(a2)
 2ca:	e79d                	bnez	a5,2f8 <ringbuf_start_write+0x64>
    *bytes = 4096*16 -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 2cc:	00001697          	auipc	a3,0x1
 2d0:	91468693          	addi	a3,a3,-1772 # be0 <rings>
 2d4:	669c                	ld	a5,8(a3)
 2d6:	6398                	ld	a4,0(a5)
 ...
 304:	8e078793          	addi	a5,a5,-1824 # be0 <rings>
 ...
 318:	bfd9                	j	2ee <ringbuf_start_write+0x5a>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 32e:	8b650513          	addi	a0,a0,-1866 # be0 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 364:	88050513          	addi	a0,a0,-1920 # be0 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 39a:	84a50513          	addi	a0,a0,-1974 # be0 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 3f0:	7f450513          	addi	a0,a0,2036 # be0 <rings>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 5e8:	fed70fa3          	sb	a3,-1(a4) # ffff <__global_pointer$+0xec2e>
    while(n-- > 0)
...
free(void *ap)
{
 ...
 a3e:	19e7b783          	ld	a5,414(a5) # bd8 <freep>
 ...
 a6c:	00e6ea63          	bltu	a3,a4,a80 <free+0x50>
{
 ...
 aae:	12f73723          	sd	a5,302(a4) # bd8 <freep>
}
 ab2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 ae0:	0fc53503          	ld	a0,252(a0) # bd8 <freep>
 ...
 b08:	0d490913          	addi	s2,s2,212 # bd8 <freep>
  if(p == (char*)-1)
 b0c:	5afd                	li	s5,-1
 b0e:	a895                	j	b82 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 b10:	00000797          	auipc	a5,0x0
 b14:	1c078793          	addi	a5,a5,448 # cd0 <base>
 b18:	00000717          	auipc	a4,0x0
 b1c:	0cf73023          	sd	a5,192(a4) # bd8 <freep>
 b20:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 b44:	08a73c23          	sd	a0,152(a4) # bd8 <freep>
      return (void*)(p + 1);
