...
int create_or_close_the_buffer_user(char name[16], int open_close){
  ...
  ca:	9da48493          	addi	s1,s1,-1574 # aa0 <rings+0x10>
  ce:	00001917          	auipc	s2,0x1
  d2:	ac290913          	addi	s2,s2,-1342 # b90 <__BSS_END__>
  d6:	04f59563          	bne	a1,a5,120 <create_or_close_the_buffer_user+0x70>
    for(i = 0; i < 10; i++){
      if(rings[i].exists == 0){
  da:	00001497          	auipc	s1,0x1
  de:	9c64a483          	lw	s1,-1594(s1) # aa0 <rings+0x10>
  ...
  ec:	9a890913          	addi	s2,s2,-1624 # a90 <rings>
  f0:	00093603          	ld	a2,0(s2)
  f4:	4585                	li	a1,1
  f6:	00000097          	auipc	ra,0x0
  fa:	4de080e7          	jalr	1246(ra) # 5d4 <ringbuf>
 ...
 130:	4a8080e7          	jalr	1192(ra) # 5d4 <ringbuf>
        rings[i].exists = 0;
...
void ringbuf_start_write(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 166:	92e70713          	addi	a4,a4,-1746 # a90 <rings>
 16a:	97ba                	add	a5,a5,a4
 16c:	6798                	ld	a4,8(a5)
 16e:	671c                	ld	a5,8(a4)
 170:	00178693          	addi	a3,a5,1
 174:	e714                	sd	a3,8(a4)
 176:	17d2                	slli	a5,a5,0x34
 178:	93d1                	srli	a5,a5,0x34
 17a:	6741                	lui	a4,0x10
 17c:	40f707b3          	sub	a5,a4,a5
 180:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 182:	421c                	lw	a5,0(a2)
 184:	e79d                	bnez	a5,1b2 <ringbuf_start_write+0x64>
    *bytes = 4096*16 -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 186:	00001697          	auipc	a3,0x1
 18a:	90a68693          	addi	a3,a3,-1782 # a90 <rings>
 18e:	669c                	ld	a5,8(a3)
 190:	6398                	ld	a4,0(a5)
 ...
 1d2:	bfd9                	j	1a8 <ringbuf_start_write+0x5a>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 4a2:	fed70fa3          	sb	a3,-1(a4) # ffff <__global_pointer$+0xed7e>
    while(n-- > 0)
