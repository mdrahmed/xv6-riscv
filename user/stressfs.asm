...
int create_or_close_the_buffer_user(char name[16], int open_close){
 ...
 152:	a0a48493          	addi	s1,s1,-1526 # b58 <rings+0x10>
 156:	00001917          	auipc	s2,0x1
 15a:	af290913          	addi	s2,s2,-1294 # c48 <__BSS_END__>
 15e:	04f59563          	bne	a1,a5,1a8 <create_or_close_the_buffer_user+0x70>
    for(i = 0; i < 10; i++){
      if(rings[i].exists == 0){
 162:	00001497          	auipc	s1,0x1
 166:	9f64a483          	lw	s1,-1546(s1) # b58 <rings+0x10>
 ...
 174:	9d890913          	addi	s2,s2,-1576 # b48 <rings>
 178:	00093603          	ld	a2,0(s2)
 17c:	4585                	li	a1,1
 17e:	00000097          	auipc	ra,0x0
 182:	4de080e7          	jalr	1246(ra) # 65c <ringbuf>
 ...
 1b8:	4a8080e7          	jalr	1192(ra) # 65c <ringbuf>
        rings[i].exists = 0;
...
void ringbuf_start_write(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 1ee:	95e70713          	addi	a4,a4,-1698 # b48 <rings>
 1f2:	97ba                	add	a5,a5,a4
 1f4:	6798                	ld	a4,8(a5)
 1f6:	671c                	ld	a5,8(a4)
 1f8:	00178693          	addi	a3,a5,1
 1fc:	e714                	sd	a3,8(a4)
 1fe:	17d2                	slli	a5,a5,0x34
 200:	93d1                	srli	a5,a5,0x34
 202:	6741                	lui	a4,0x10
 204:	40f707b3          	sub	a5,a4,a5
 208:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 20a:	421c                	lw	a5,0(a2)
 20c:	e79d                	bnez	a5,23a <ringbuf_start_write+0x64>
    *bytes = 4096*16 -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 20e:	00001697          	auipc	a3,0x1
 212:	93a68693          	addi	a3,a3,-1734 # b48 <rings>
 216:	669c                	ld	a5,8(a3)
 218:	6398                	ld	a4,0(a5)
 ...
 246:	90678793          	addi	a5,a5,-1786 # b48 <rings>
 ...
 25a:	bfd9                	j	230 <ringbuf_start_write+0x5a>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 270:	8dc50513          	addi	a0,a0,-1828 # b48 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 2a6:	8a650513          	addi	a0,a0,-1882 # b48 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 2dc:	87050513          	addi	a0,a0,-1936 # b48 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 332:	81a50513          	addi	a0,a0,-2022 # b48 <rings>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 52a:	fed70fa3          	sb	a3,-1(a4) # ffff <__global_pointer$+0xecc6>
    while(n-- > 0)
...
free(void *ap)
{
 ...
 980:	1c47b783          	ld	a5,452(a5) # b40 <freep>
 ...
 9ae:	00e6ea63          	bltu	a3,a4,9c2 <free+0x50>
{
 ...
 9f0:	14f73a23          	sd	a5,340(a4) # b40 <freep>
}
 9f4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 a22:	12253503          	ld	a0,290(a0) # b40 <freep>
 ...
 a4a:	0fa90913          	addi	s2,s2,250 # b40 <freep>
  if(p == (char*)-1)
 a4e:	5afd                	li	s5,-1
 a50:	a895                	j	ac4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 a52:	00000797          	auipc	a5,0x0
 a56:	1e678793          	addi	a5,a5,486 # c38 <base>
 a5a:	00000717          	auipc	a4,0x0
 a5e:	0ef73323          	sd	a5,230(a4) # b40 <freep>
 a62:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a86:	0aa73f23          	sd	a0,190(a4) # b40 <freep>
      return (void*)(p + 1);
