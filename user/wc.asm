...
wc(int fd, char *name)
{
  ...
  32:	bb3d8d93          	addi	s11,s11,-1101 # be1 <buf+0x1>
  ...
  7a:	b6a58593          	addi	a1,a1,-1174 # be0 <buf>
  ...
  92:	b5248493          	addi	s1,s1,-1198 # be0 <buf>
...
int create_or_close_the_buffer_user(char name[16], int open_close){
 ...
 1dc:	c1848493          	addi	s1,s1,-1000 # df0 <rings+0x10>
 1e0:	00001917          	auipc	s2,0x1
 1e4:	d0090913          	addi	s2,s2,-768 # ee0 <__BSS_END__>
 1e8:	04f59563          	bne	a1,a5,232 <create_or_close_the_buffer_user+0x70>
    for(i = 0; i < 10; i++){
      if(rings[i].exists == 0){
 1ec:	00001497          	auipc	s1,0x1
 1f0:	c044a483          	lw	s1,-1020(s1) # df0 <rings+0x10>
 ...
 1fe:	be690913          	addi	s2,s2,-1050 # de0 <rings>
 202:	00093603          	ld	a2,0(s2)
 206:	4585                	li	a1,1
 208:	00000097          	auipc	ra,0x0
 20c:	4de080e7          	jalr	1246(ra) # 6e6 <ringbuf>
 ...
 242:	4a8080e7          	jalr	1192(ra) # 6e6 <ringbuf>
        rings[i].exists = 0;
...
void ringbuf_start_write(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 278:	b6c70713          	addi	a4,a4,-1172 # de0 <rings>
 27c:	97ba                	add	a5,a5,a4
 27e:	6798                	ld	a4,8(a5)
 280:	671c                	ld	a5,8(a4)
 282:	00178693          	addi	a3,a5,1
 286:	e714                	sd	a3,8(a4)
 288:	17d2                	slli	a5,a5,0x34
 28a:	93d1                	srli	a5,a5,0x34
 28c:	6741                	lui	a4,0x10
 28e:	40f707b3          	sub	a5,a4,a5
 292:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 294:	421c                	lw	a5,0(a2)
 296:	e79d                	bnez	a5,2c4 <ringbuf_start_write+0x64>
    *bytes = 4096*16 -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 298:	00001697          	auipc	a3,0x1
 29c:	b4868693          	addi	a3,a3,-1208 # de0 <rings>
 2a0:	669c                	ld	a5,8(a3)
 2a2:	6398                	ld	a4,0(a5)
 ...
 2d0:	b1478793          	addi	a5,a5,-1260 # de0 <rings>
 ...
 2e4:	bfd9                	j	2ba <ringbuf_start_write+0x5a>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 2fa:	aea50513          	addi	a0,a0,-1302 # de0 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 330:	ab450513          	addi	a0,a0,-1356 # de0 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ // address ta double pointer hobe
 ...
 366:	a7e50513          	addi	a0,a0,-1410 # de0 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 3bc:	a2850513          	addi	a0,a0,-1496 # de0 <rings>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 5b4:	fed70fa3          	sb	a3,-1(a4) # ffff <__global_pointer$+0xec2e>
    while(n-- > 0)
...
free(void *ap)
{
 ...
 a0a:	1d27b783          	ld	a5,466(a5) # bd8 <freep>
 ...
 a38:	00e6ea63          	bltu	a3,a4,a4c <free+0x50>
{
 ...
 a7a:	16f73123          	sd	a5,354(a4) # bd8 <freep>
}
 a7e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 aac:	13053503          	ld	a0,304(a0) # bd8 <freep>
 ...
 ad4:	10890913          	addi	s2,s2,264 # bd8 <freep>
  if(p == (char*)-1)
 ad8:	5afd                	li	s5,-1
 ada:	a895                	j	b4e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 adc:	00000797          	auipc	a5,0x0
 ae0:	3f478793          	addi	a5,a5,1012 # ed0 <base>
 ae4:	00000717          	auipc	a4,0x0
 ae8:	0ef73a23          	sd	a5,244(a4) # bd8 <freep>
 aec:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 b10:	0ca73623          	sd	a0,204(a4) # bd8 <freep>
      return (void*)(p + 1);
