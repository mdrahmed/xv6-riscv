...
int create_or_close_the_buffer_user(char name[16], int open_close, uint64 **addr){
  ...
  84:	a0048493          	addi	s1,s1,-1536 # a80 <rings+0x8>
  88:	00001917          	auipc	s2,0x1
  8c:	ae890913          	addi	s2,s2,-1304 # b70 <base+0x8>
    }
  }
  else{
    for(i = 0; i < 10; i++){
  ...
  90:	00001b17          	auipc	s6,0x1
  94:	9d8b0b13          	addi	s6,s6,-1576 # a68 <vm_addr>
  if(open_close == 1){
  98:	04f59063          	bne	a1,a5,d8 <create_or_close_the_buffer_user+0x74>
      if(rings[i].exists == 0){
  9c:	00001497          	auipc	s1,0x1
  a0:	9ec4a483          	lw	s1,-1556(s1) # a88 <rings+0x10>
  a4:	c099                	beqz	s1,aa <create_or_close_the_buffer_user+0x46>
  a6:	4481                	li	s1,0
  a8:	a899                	j	fe <create_or_close_the_buffer_user+0x9a>
        ringbuf(name, open_close, &vm_addr);
  aa:	865a                	mv	a2,s6
  ac:	4585                	li	a1,1
  ae:	00000097          	auipc	ra,0x0
  b2:	4da080e7          	jalr	1242(ra) # 588 <ringbuf>
        rings[i].book->write_done = 0;
  b6:	00001797          	auipc	a5,0x1
  ba:	9c278793          	addi	a5,a5,-1598 # a78 <rings>
  be:	6798                	ld	a4,8(a5)
  c0:	00073423          	sd	zero,8(a4)
        rings[i].book->read_done = 0;
  c4:	6798                	ld	a4,8(a5)
  c6:	00073023          	sd	zero,0(a4)
        rings[i].exists++;
  ca:	4b98                	lw	a4,16(a5)
  cc:	2705                	addiw	a4,a4,1
  ce:	cb98                	sw	a4,16(a5)
        break;
  d0:	a03d                	j	fe <create_or_close_the_buffer_user+0x9a>
    for(i = 0; i < 10; i++){
  d2:	04e1                	addi	s1,s1,24
  d4:	03248463          	beq	s1,s2,fc <create_or_close_the_buffer_user+0x98>
      if(rings[i].exists != 0){
  d8:	449c                	lw	a5,8(s1)
  da:	dfe5                	beqz	a5,d2 <create_or_close_the_buffer_user+0x6e>
        ringbuf(name, open_close, &vm_addr);
  dc:	865a                	mv	a2,s6
  de:	85ce                	mv	a1,s3
  e0:	8552                	mv	a0,s4
  e2:	00000097          	auipc	ra,0x0
  e6:	4a6080e7          	jalr	1190(ra) # 588 <ringbuf>
        rings[i].book->write_done = 0;
  ea:	609c                	ld	a5,0(s1)
  ec:	0007b423          	sd	zero,8(a5)
        rings[i].book->read_done = 0;
  f0:	609c                	ld	a5,0(s1)
  f2:	0007b023          	sd	zero,0(a5)
        rings[i].exists = 0;
  f6:	0004a423          	sw	zero,8(s1)
  fa:	bfe1                	j	d2 <create_or_close_the_buffer_user+0x6e>
    for(i = 0; i < 10; i++){
  fc:	44a9                	li	s1,10
 ...
 102:	96a7b783          	ld	a5,-1686(a5) # a68 <vm_addr>
 106:	00fab023          	sd	a5,0(s5)
  return i;
}
 10a:	8526                	mv	a0,s1
 10c:	70e2                	ld	ra,56(sp)
 10e:	7442                	ld	s0,48(sp)
 110:	74a2                	ld	s1,40(sp)
 112:	7902                	ld	s2,32(sp)
...
void ringbuf_start_write(int ring_desc, uint64 **addr, int *bytes){ 
 ...
 172:	90a78793          	addi	a5,a5,-1782 # a78 <rings>
 ...
 186:	bfd9                	j	15c <ringbuf_start_write+0x3c>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 19c:	8e050513          	addi	a0,a0,-1824 # a78 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 1d2:	8aa50513          	addi	a0,a0,-1878 # a78 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ 
 ...
 208:	87450513          	addi	a0,a0,-1932 # a78 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 25e:	81e50513          	addi	a0,a0,-2018 # a78 <rings>
...
malloc(uint nbytes)
{
 ...
 982:	1ea78793          	addi	a5,a5,490 # b68 <base>
