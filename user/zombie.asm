...
int create_or_close_the_buffer_user(char name[16], int open_close, uint64 **addr){
  ...
  76:	9c648493          	addi	s1,s1,-1594 # a38 <rings+0x8>
  7a:	00001917          	auipc	s2,0x1
  7e:	aae90913          	addi	s2,s2,-1362 # b28 <base+0x8>
    }
  }
  else{
    for(i = 0; i < 10; i++){
  ...
  86:	99eb0b13          	addi	s6,s6,-1634 # a20 <vm_addr>
  if(open_close == 1){
  8a:	04f59063          	bne	a1,a5,ca <create_or_close_the_buffer_user+0x74>
      if(rings[i].exists == 0){
  8e:	00001497          	auipc	s1,0x1
  92:	9b24a483          	lw	s1,-1614(s1) # a40 <rings+0x10>
  96:	c099                	beqz	s1,9c <create_or_close_the_buffer_user+0x46>
  98:	4481                	li	s1,0
  9a:	a899                	j	f0 <create_or_close_the_buffer_user+0x9a>
        ringbuf(name, open_close, &vm_addr);
  9c:	865a                	mv	a2,s6
  9e:	4585                	li	a1,1
  a0:	00000097          	auipc	ra,0x0
  a4:	4da080e7          	jalr	1242(ra) # 57a <ringbuf>
        rings[i].book->write_done = 0;
  a8:	00001797          	auipc	a5,0x1
  ac:	98878793          	addi	a5,a5,-1656 # a30 <rings>
  b0:	6798                	ld	a4,8(a5)
  b2:	00073423          	sd	zero,8(a4)
        rings[i].book->read_done = 0;
  b6:	6798                	ld	a4,8(a5)
  b8:	00073023          	sd	zero,0(a4)
        rings[i].exists++;
  bc:	4b98                	lw	a4,16(a5)
  be:	2705                	addiw	a4,a4,1
  c0:	cb98                	sw	a4,16(a5)
        break;
  c2:	a03d                	j	f0 <create_or_close_the_buffer_user+0x9a>
    for(i = 0; i < 10; i++){
  c4:	04e1                	addi	s1,s1,24
  c6:	03248463          	beq	s1,s2,ee <create_or_close_the_buffer_user+0x98>
      if(rings[i].exists != 0){
  ca:	449c                	lw	a5,8(s1)
  cc:	dfe5                	beqz	a5,c4 <create_or_close_the_buffer_user+0x6e>
        ringbuf(name, open_close, &vm_addr);
  ce:	865a                	mv	a2,s6
  d0:	85ce                	mv	a1,s3
  d2:	8552                	mv	a0,s4
  d4:	00000097          	auipc	ra,0x0
  d8:	4a6080e7          	jalr	1190(ra) # 57a <ringbuf>
        rings[i].book->write_done = 0;
  dc:	609c                	ld	a5,0(s1)
  de:	0007b423          	sd	zero,8(a5)
        rings[i].book->read_done = 0;
  e2:	609c                	ld	a5,0(s1)
  e4:	0007b023          	sd	zero,0(a5)
        rings[i].exists = 0;
  e8:	0004a423          	sw	zero,8(s1)
  ec:	bfe1                	j	c4 <create_or_close_the_buffer_user+0x6e>
    for(i = 0; i < 10; i++){
  ee:	44a9                	li	s1,10
  ...
  *addr = (uint64*)vm_addr;
  ...
  f4:	9307b783          	ld	a5,-1744(a5) # a20 <vm_addr>
  f8:	00fab023          	sd	a5,0(s5)
  return i;
}
  fc:	8526                	mv	a0,s1
  fe:	70e2                	ld	ra,56(sp)
 100:	7442                	ld	s0,48(sp)
 102:	74a2                	ld	s1,40(sp)
 104:	7902                	ld	s2,32(sp)
 106:	69e2                	ld	s3,24(sp)
 108:	6a42                	ld	s4,16(sp)
 10a:	6aa2                	ld	s5,8(sp)
 10c:	6b02                	ld	s6,0(sp)
 10e:	6121                	addi	sp,sp,64
 110:	8082                	ret

0000000000000112 <ringbuf_start_write>:
...
void ringbuf_start_write(int ring_desc, uint64 **addr, int *bytes){ 
 ...
 122:	9027b783          	ld	a5,-1790(a5) # a20 <vm_addr>
 126:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 128:	421c                	lw	a5,0(a2)
 12a:	e79d                	bnez	a5,158 <ringbuf_start_write+0x46>
    *bytes = (4096*16) -(rings[ring_desc].book->write_done - rings[0].book->read_done);
 12c:	00001697          	auipc	a3,0x1
 130:	90468693          	addi	a3,a3,-1788 # a30 <rings>
 134:	669c                	ld	a5,8(a3)
 136:	6398                	ld	a4,0(a5)
 ...
 164:	8d078793          	addi	a5,a5,-1840 # a30 <rings>
 ...
 178:	bfd9                	j	14e <ringbuf_start_write+0x3c>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 18e:	8a650513          	addi	a0,a0,-1882 # a30 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 1c4:	87050513          	addi	a0,a0,-1936 # a30 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ 
 ...
 1fa:	83a50513          	addi	a0,a0,-1990 # a30 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 250:	7e450513          	addi	a0,a0,2020 # a30 <rings>
...
free(void *ap)
{
 ...
 89e:	18e7b783          	ld	a5,398(a5) # a28 <freep>
 ...
 8cc:	00e6ea63          	bltu	a3,a4,8e0 <free+0x50>
{
 ...
 90e:	10f73f23          	sd	a5,286(a4) # a28 <freep>
}
 912:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 940:	0ec53503          	ld	a0,236(a0) # a28 <freep>
 ...
 968:	0c490913          	addi	s2,s2,196 # a28 <freep>
  if(p == (char*)-1)
 96c:	5afd                	li	s5,-1
 96e:	a895                	j	9e2 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 970:	00000797          	auipc	a5,0x0
 974:	1b078793          	addi	a5,a5,432 # b20 <base>
 978:	00000717          	auipc	a4,0x0
 97c:	0af73823          	sd	a5,176(a4) # a28 <freep>
 980:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9a4:	08a73423          	sd	a0,136(a4) # a28 <freep>
      return (void*)(p + 1);
