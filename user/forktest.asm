...
int create_or_close_the_buffer_user(char name[16], int open_close, uint64 **addr){
 ...
 162:	8ab2                	mv	s5,a2
  ...
  if(open_close == 1){
 164:	4785                	li	a5,1
 166:	00000497          	auipc	s1,0x0
 16a:	59248493          	addi	s1,s1,1426 # 6f8 <rings+0x8>
 16e:	00000917          	auipc	s2,0x0
 172:	67a90913          	addi	s2,s2,1658 # 7e8 <__BSS_END__+0x8>
    }
  }
  else{
    for(i = 0; i < 10; i++){
 ...
 176:	00000b17          	auipc	s6,0x0
 17a:	572b0b13          	addi	s6,s6,1394 # 6e8 <vm_addr>
  if(open_close == 1){
 17e:	04f59063          	bne	a1,a5,1be <create_or_close_the_buffer_user+0x74>
      if(rings[i].exists == 0){
 182:	00000497          	auipc	s1,0x0
 186:	57e4a483          	lw	s1,1406(s1) # 700 <rings+0x10>
 ...
 1a0:	55478793          	addi	a5,a5,1364 # 6f0 <rings>
 1a4:	6798                	ld	a4,8(a5)
 ...
 1e8:	5047b783          	ld	a5,1284(a5) # 6e8 <vm_addr>
...
void ringbuf_start_write(int ring_desc, uint64 **addr, int *bytes){ 
 ...
 210:	84b2                	mv	s1,a2
  *addr = (uint64*)vm_addr;
 212:	00000797          	auipc	a5,0x0
 216:	4d67b783          	ld	a5,1238(a5) # 6e8 <vm_addr>
 21a:	e19c                	sd	a5,0(a1)
  if(*bytes == 0){
 21c:	421c                	lw	a5,0(a2)
 ...
 224:	4d068693          	addi	a3,a3,1232 # 6f0 <rings>
 228:	669c                	ld	a5,8(a3)
 22a:	6398                	ld	a4,0(a5)
 ...
 258:	49c78793          	addi	a5,a5,1180 # 6f0 <rings>
...
void ringbuf_finish_write(int ring_desc, int bytes){
 ...
 282:	47250513          	addi	a0,a0,1138 # 6f0 <rings>
...
void check_bytes_written(int ring_desc, int *bytes){
 ...
 2b8:	43c50513          	addi	a0,a0,1084 # 6f0 <rings>
...
void ringbuf_start_read(int ring_desc, uint64 *addr, int *bytes){ 
 ...
 2ee:	40650513          	addi	a0,a0,1030 # 6f0 <rings>
...
void ringbuf_finish_read(int ring_desc, int bytes){
 ...
 344:	3b050513          	addi	a0,a0,944 # 6f0 <rings>
